...
const ModeChange = () => {
    ...
    return (
        <div className="mode-change">
            <input onChange={()=>setMode([1,0])} type="radio" name="mode" id="runtime" className="mode-change__input-1"></input>
            <label htmlFor="runtime" className="mode-change__label label--runtime">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="#4D5562">
            ...
            <input onChange={()=>setMode([0,1])} type="radio" name="mode" defaultChecked id="constructor" className="mode-change__input-2"></input>
            <label htmlFor="constructor" className="mode-change__label label--constructor">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="#4D5562">
            ...
            <div className={"mode-change__active" + (mode[0] ? " mode-change__active--runtime": '')}></div>
        </div>
    );
};
